#!/usr/bin/env python3
"""Update Baseball America dynasty rankings from Apr 2026 to May 2026."""
...
OLD_COL = "Baseball America (Apr 2026)"
NEW_COL = "Baseball America (May 2026)"

# Draft pick slots omitted (ranks 128, 139, 201, 229, 260, 298, 378)
NEW_RANKINGS = [
    (1,   "Shohei Ohtani"),
    (2,   "Bobby Witt Jr."),
    (3,   "Paul Skenes"),
